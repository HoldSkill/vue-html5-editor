 ...
 * build at Sun Dec 31 2017 11:29:15 GMT+0800 (中国标准时间)
 */
...
var template$3 = "<div> <div v-show=\"upload.status=='ready'\"> <input type=\"text\" v-model=\"imageUrl\" maxlength=\"255\" :placeholder=\"$parent.locale['please enter a url']\"> <button type=\"button\" @click=\"insertImageUrl\">{{$parent.locale.save}}</button> <button type=\"button\" @click=\"pick\">{{$parent.locale.upload}}</button> </div> </div> ";
